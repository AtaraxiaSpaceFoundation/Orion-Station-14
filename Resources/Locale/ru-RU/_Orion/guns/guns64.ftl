...
ent-WeaponShotgun39 = XM1014
    .desc = Боевое ружье Earth Armories XM1014 - это полуавтоматическое ружье, используемое солдатами в отрядах армии Земли. Использует патроны для дробовика 50-го калибра.
    .suffix = Дробовик
