...
mood-effect-DrankInsectBlood =
    Я только что выпил слизкую насекомую жижу. Это отвратительно!
mood-effect-DrankVomit =
    Зачем я только что выпил эту рвоту? Она на вкус как рвота!
...
mood-effect-OilyEffect =
    Я съел что-то, приготовленное в масле.
mood-effect-SaltyEffect =
    Я съел что-то солёное, было очень вкусно!
mood-effect-MintyEffect =
    Я съел что-то мятное, это было прохладно и освежающе.
mood-effect-PepperEffect =
    Я съел что-то перчёное, было очень вкусно!
mood-effect-ChocolateEffect =
    Я съел что-то с шоколадом, это было невероятно вкусно!
mood-effect-ButterEffect =
    Я съел масляное лакомство, мог бы есть это весь день.
mood-effect-DeepFriedEffect =
    Я съел что-то во фритюре! Это было самое вкусное, что я когда-либо ел!
