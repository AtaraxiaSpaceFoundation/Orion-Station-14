...
uplink-rifle-mag-desc = 25 патронов 5.56мм калибра. Для Lecter и M-90.
...
uplink-pistol-magazine-caseless-saphe-name = Пистолетный магазин (9.5мм бронебойные взрывные)
...
uplink-shotgun-magazine-desc = Барабанный магазин с 8 дробовыми патронами. Совместим с "Бульдог" и "Зауэр".
uplink-shotgun-magazine-slug-name = Барабан (.50 пуля)
uplink-shotgun-magazine-slug-desc = Барабанный магазин с 8 пулевыми патронами. Совместим с "Бульдог" и "Зауэр".
...
uplink-estoc-ammo-desc = 25 патронов 5.45мм калибра. Для Эстока.
