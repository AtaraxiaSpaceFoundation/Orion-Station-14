...
uplink-m90-desc = Более дешевая модификация M-90GL, в которой отсутствует встроенный гранатомет. Питание от 5.56мм винтовочных магазинов.
uplink-estoc-name = Эсток
uplink-estoc-desc = Стрелковая винтовка, предназначенная для стрельбы очередями и оснащенная дорогой тритиевой оптикой. Питание от 5.56мм винтовочных магазинов.
