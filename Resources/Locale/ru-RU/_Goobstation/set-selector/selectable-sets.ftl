...
selectable-set-syndicate-hacker-description =
    ...
    её ИИ, боргов и команды безопасности. ВЗЛОМАЙ ПЛАНЕТУ!
    Включает: экспериментальную плату законов, устройство сбоя аутентификации, ЕМАГ,
    жучок для камер, заполненный набор инструментов, костюм акробата,
    стильные очки и так же ключи шифрования Синдиката и бинарного кода.
...
selectable-set-ert-ballistic-description =
    ...
    Включает: винтовку Энни калибра 5.45мм,
