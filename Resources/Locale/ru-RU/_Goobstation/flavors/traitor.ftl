...
traitor-donkcorporation-roundend = [color=orange]сотрудник Корпорации Донк[/color]
...
traitor-tigercooperative-roundend = [color=crimson]фанатик Кооператив Тигра[/color]
...
traitor-wafflecorporationterrorist-roundend = [color=red]террорист Корпорация Ваффель[/color]
