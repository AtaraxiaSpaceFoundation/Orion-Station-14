...
job-description-roboticist = Создавайте и обслуживайте боргов и мехов. Контролируйте искусственный интеллект.
job-description-radiohost = Ведите трансляцию на местной радиостанции, проигрывайте винилы, берите интервью у съемочной группы, принимайте факсы и размещайте рекламу, чтобы создать лучшее радиошоу на радиостанции.
