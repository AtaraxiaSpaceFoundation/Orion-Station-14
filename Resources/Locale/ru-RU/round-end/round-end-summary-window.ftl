...
round-end-summary-window-player-info-if-observer-text = [color=gray]{ $playerICName }[/color] был [color=lightblue]{ $playerICName }[/color], наблюдатель.
round-end-summary-window-player-info-if-not-observer-text = [color=gray]{ $playerICName }[/color] был [color={ $icNameColor }]{ $playerICName }[/color], в роли [color=orange]{ $playerRole }[/color].
