...
CHANGELOG_PATH = REPO_ROOT / "Resources" / "Changelog" / "ChangelogOrion.yml"
...
def update_changelog(file_path, new_entries):
    ...
    name = existing.get("Name", "Orionlog")
    ...
    logging.info("Updated PR data saved to ChangelogOrion.yml")
