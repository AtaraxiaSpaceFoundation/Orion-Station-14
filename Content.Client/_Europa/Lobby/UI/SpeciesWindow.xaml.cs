...
public sealed partial class SpeciesWindow : FancyWindow
{
    ...
    public void SelectSpecies(ProtoId<SpeciesPrototype> protoId)
    {
        ...
        var mob = _uIController.LoadProfileEntity(previewProfile, _proto.Index(job), false);
        Mob.SetEntity(mob);

        var loadoutMob = _uIController.LoadProfileEntity(previewProfile, _proto.Index(job), true);
